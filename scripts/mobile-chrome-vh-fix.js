...
VHChromeFix.prototype.fixAll = function() {
  ...
  for (var i = 0; i < this.elements.length; i++) {
    ...
    switch (element.property) {
      ...
      case 'min-height':
        element.domElement.style.minHeight = (window.innerHeight * element.vh / 100) + 'px';
        break;

      case 'top':
        element.domElement.style.top = (window.innerHeight * element.vh / 100) + 'px';
        break;

      default:
        console.log("Property not valid");
    }
  }
};
